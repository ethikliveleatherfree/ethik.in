$(document).ready(function() {
	...
	$(".slider").slidesjs({ height: 300,
	pagination:{active: false},
	navigation:{active: false},
	play:{ auto: true, interval: 5000, effect: "fade" }
	});
	...
	function fadeHomeUp(){
		...
		$('#home .btn').removeClass('fadeInUp');
		$('#home .btn').addClass('fadeOutUp');
	}
	...
	function fadeHomeDown(){
		...
		$('#home .btn').addClass('fadeInUp');
		$('#home .btn').removeClass('fadeOutUp');
	}
