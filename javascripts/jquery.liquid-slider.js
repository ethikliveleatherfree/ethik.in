    ...
    addArrows: function () {
      ...
      if (self.options.dynamicArrows) {
        ...
        if (self.options.dynamicArrowsGraphical) {
          (self.$sliderId).before('<div class="liquid-nav-left-arrow" data-liquidslider-dir="prev" title="Slide left"><i class="icon-chevron-left"></i><a href="#"></a></div>');
          (self.$sliderId).after('<div class="liquid-nav-right-arrow" data-liquidslider-dir="next" title="Slide right"><i class="icon-chevron-right"></i><a href="#"></a></div>');
        } else {
